...
public class ItemRegistry
{
    ...
    public static final DeferredItem<Item> CALL_CRYSTAL = Main.ITEMS.registerItem("call_crystal", CallCrystal::new, new Item.Properties().rarity(Rarity.UNCOMMON));
    public static final DeferredItem<Item> DEEP_CALL_CRYSTAL = Main.ITEMS.registerItem("deep_call_crystal", DeepCallCrystal::new, new Item.Properties().rarity(Rarity.RARE));
